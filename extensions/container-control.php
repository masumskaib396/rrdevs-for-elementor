...
class RRdevs_Container_Extras
{
	...
	public function __construct()
	{
		...
		add_action("elementor/element/after_section_end", array($this, 'rrdevs_section_add_extra_controls'), 19, 3);
	}


	public function rrdevs_section_add_extra_controls($widget, $section_id, $args)
	{
		...
		$widget->start_controls_section(
			'rrdevs_section_advanced_container_extra',
			array(
...
RRdevs_Container_Extras::get_instance();
